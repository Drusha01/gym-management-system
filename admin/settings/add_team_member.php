...
if(isset($_SESSION['admin_id'])){
    ...
    if($_SESSION['admin_user_status_details'] == 'active'){
        ...
        if($_SESSION['admin_user_type_details'] == 'admin'){
            ...
            if(isset($_POST['team_name']) && isset($_FILES['file']) && isset($_POST['position'])){
                // 
                ...
                if (validate_file($_FILES, 'file', $type, $size)) {
                    ...
                    if($result){
                        ...
                        $team_positionsObj->insert($position);
                        $teamsObj = new teams();

                        if($teamsObj->insert($position,$team_name,$filename)){
                            // get id of
                            echo json_encode($teamsObj->fetch_with_file($filename));
                        }else{
                            echo '0';
                        }
                    }
