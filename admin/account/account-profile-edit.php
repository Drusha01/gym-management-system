...
function savepassword(){
    ...
    validatedPassowrdConfirmPassword(new_password,confirm_password)&& !validatedPassowrdConfirmPassword(new_password,current_password)){
        ...
        xhttp.open("POST", "user-edit-ajax-savepassword.php?user_id="+user_name, true);
...
function save_profile_info(){
    ...
    // user id
    var user_id = $('#username').val();
    xhttp_save_profile.open("POST", "user-edit-ajax-save-profile.php?user_id="+user_id, true);
...
function save_pictures(){
    ...
    var user_id = $('#username').val();
    xhttp_save_profile_pictures.open("POST", "user-edit-ajax-picture.php?user_id="+user_id);
