<div class="container-exp">
    <div class="row g-2 mb-2 mt-1">
        <div class="form-group col-12 col-sm-3 table-filter-option">
            <label>Type</label>
            <select name="categoryFilter-2" id="categoryFilter-2" class="form-select ms-md-2">
        ...
        <div class="form-group col-12 col-sm-3 table-filter-option">
            ...
            <select name="categoryFilter-2" id="categoryFilter-2" class="form-select ms-md-2">
                <option value="">All</option>
                <option value="Gym-Use Subscription">Nearing</option>
                <option value="Trainer Subscription">Expired</option>
            </select>
        </div>
